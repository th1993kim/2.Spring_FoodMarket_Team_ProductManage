				                ...
				                <div class="ordered-product">
				                  <div class="card-header">
				                    <div class="row justify-content-between mb-3">
				                        <div class="col-auto">
				                            <h6 class="color-1 mb-0 change-color">${orderedList.order_date}주문</h6>
				                        </div>
				                        <div class="col-auto see-order-details"><a href="#">주문 상세보기</a></div>
				                    </div>
				                    <div class="row">
				                        <div class="col">
				                            <div class="card card-2">
				                                <div class="card-body">
				                                  ...
				                                  <div class="media">
				                                    <div class="sq align-self-center "> <img class="img-fluid my-auto align-self-center mr-2 mr-md-4 pl-0 p-0 m-0" src="C:\Users\remyd\OneDrive\Bureau\Shopping_mall\img\apple.jpg" width="135" height="135" /> </div>
				                                    <div class="media-body my-auto">
				                                        <div class="row my-auto flex-column flex-md-row">
				                                            <div class="col my-auto">
				                                                <h6 class="mb-0">${orderedList.product_name}</h6>
				                                            </div>
				                                            <div class="col-auto my-auto"> ${orderedList.order_product_price}원 / ${orderedList.order_product_amount}개 </div>
				                                            <div class="col my-auto"> <button type="button" class="btn btn-outline-danger">장바구니 담기</button></div>
				                                            <div class="col my-auto">
				                                               <div class="button-option">
				                                                <button type="button" class="btn btn-outline-secondary btn-sm button2">배송 조회</button>
				                                                <button type="button" class="btn btn-outline-secondary btn-sm button2">반품 신청</button>
				                                                <button type="button" class="btn btn-outline-secondary btn-sm button2 insertReview" data-target="#insertReviewModal" data-toggle="modal" value="${orderedList.product_id}">리뷰 작성</button>
				                                              </div>
				                                            </div>
				                                          </div>
				                                     </div>
