...
<div class="container">
  <h2>리뷰 입력</h2>
	...
	<!-- The Modal -->
  <div class="modal fade" id="insertReviewModal">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
       	<form action="/review/insert.do" class="was-validated" id="insert_form" name="insert_form">
			...
			<div class="form-group">
				...
				<select class="form-control" id="starReview" name="review_star" required>
					<option></option>
					<option>1</option>
					<option>2</option>
					<option>3</option>
