...
public class ReviewPagingDTO {
	...
	private int perPage = 5;	//보이는 게시글 수
	private int start;			//쿼리문에 사용 , 시작행번호
	private int end;			//쿼리문에 사용, 읽어올 행수
	private int product_id;			//쿼리문에 사용, 읽어올 행수
		
		public ReviewPagingDTO() {	}
			
		public ReviewPagingDTO(int total, int currentPage) {
			this.total = total;
		...
		public String toString() {
			return "ReviewPagingDTO [total=" + total + ", currentPage=" + currentPage + ", totalPages=" + totalPages
